...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({CountOutOfBoundsException.class, NotMatchException.class, NotFoundException.class, DuplicateException.class, InvalidException.class, OAuthProviderNotExistException.class})
