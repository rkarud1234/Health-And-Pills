...
public class UserFixture {
    ...
    public static final double USSER_PROFILE_WEIGHT = 70;
    ...
    public static final UserInfoResponse TEST_USER_INFO_RESPONSE
            = new UserInfoResponse(USER_PROFILE_NICKNAME,USER_PROFILE_BIRTHDAY,USER_PROFILE_GENDER, EXERCISE_ID, EXERCISE_ID, USER_PROFILE_HEIGHT, USSER_PROFILE_WEIGHT, USER_PROFILE_FAT, USER_PROFILE_SKELETON, USER_PROFILE_WATER);
    ...
    public static final UpdateUserInbodyRequest TEST_UPDATE_USER_INBODY_REQUEST
            = new UpdateUserInbodyRequest(USER_PROFILE_HEIGHT, USSER_PROFILE_WEIGHT, USER_PROFILE_FAT, USER_PROFILE_SKELETON, USER_PROFILE_WATER);
}
