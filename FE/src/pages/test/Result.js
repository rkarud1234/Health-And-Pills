  ...
  const sharekakao = () => {
    ...
    Kakao.Link.sendDefault({
      ...
      content: {
        ...
        imageUrl: `https://j7b203.p.ssafy.io/static/media/001.a26b8d48c31fe4e3c8bc.jpg`,
        link: {
      ...
      {!isLoading ? (
        ...
        <div style={{ backgroundColor: "#EAEFF1", paddingBottom: "50px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <TextBox style={{ paddingTop: "20px" }}>
              HP가 확인한 당신의 신체 나이 연령대는
            </TextBox>
          </div>
          <TextBox style={{ fontSize: "24px", fontWeight: "bold" }}>
          ...
          <BtnBox>
            <Btn className="kakao_share" onClick={copyUrl} bgcolor="white">
              링크 복사하기
            </Btn>
          </BtnBox>
          <BtnBox>
            <Btn className="kakao_share" onClick={sharekakao} bgcolor="#f1d900">
              카카오톡 공유하기
            </Btn>
          </BtnBox>
