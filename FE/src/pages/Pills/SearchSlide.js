...
const SearchSlide = ({ openHandler }) => {
  ...
  const functionalityList = useSelector(
    (state) => state.search.functionalityList,
  );
                  ...
                  <div style={{ margin: "8px 12px", display: "flex" }}>
                    ...
                    {isOpened && (
                      <div
                        ...
                        onClick={() => {
                          nutrientHandler(nutrient.nutrientId);
                        }}
                      >
                  ...
                  <div style={{ margin: "8px", display: "flex" }}>
                    ...
                    {isOpened && (
                      <div
                        style={{ cursor: "pointer" }}
                        onClick={() => {
                          functionalityHandler(functionalitiy.functionalityId);
                        }}
                      >
      ...
      {isOpened && (
        <Category>
              ...
              {nutrients &&
                nutrients.map((nutrient) => {
                  return (
                    <CategoryBtn
                      className={
                        nutrientList.includes(nutrient.nutrientId)
                          ? "selected"
                          : "noselected"
                      }
                      key={nutrient.nutrientId}
              ...
              {functionalities &&
                functionalities.map((functionalitiy) => {
                  return (
                    <CategoryBtn
                      className={
                        functionalityList.includes(
                          functionalitiy.functionalityId,
                        )
                          ? "selected"
                          : "noselected"
                      }
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            ...
            <CustomBtn onClick={searchHandler} className="search">
              바로 검색
            </CustomBtn>
          </div>
        </Category>
